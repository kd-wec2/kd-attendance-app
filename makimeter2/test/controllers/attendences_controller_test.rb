...
class AttendencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendence" do
    assert_difference('Attendence.count') do
      post attendences_url, params: { attendence: { date: @attendence.date, fifth: @attendence.fifth, first: @attendence.first, forth: @attendence.forth, second: @attendence.second, third: @attendence.third, user_id: @attendence.user_id } }
    end
  ...
  test "should update attendence" do
    patch attendence_url(@attendence), params: { attendence: { date: @attendence.date, fifth: @attendence.fifth, first: @attendence.first, forth: @attendence.forth, second: @attendence.second, third: @attendence.third, user_id: @attendence.user_id } }
